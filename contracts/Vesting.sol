...
contract Vesting is IERC1620, ReentrancyGuard, CarefulMath {
    ...
    /// @notice Contract logic starts here.
    constructor() public {
        nextStreamId = 1;
    }
     ...
     * returns delta: The time delta in seconds.
     */
     ...
     * returns The total funds allocated to `who` as uint256.
     */
